...
class CircularMenuState extends State<CircularMenu>
  ...
  Widget _buildMenuButton(BuildContext context) {
    ...
    return Positioned(
      left: this._left ?? sizeMo.width / 2 - 35,
      top: this._top ?? sizeMo.height - 80,
      child: Draggable(
  ...
  void _handleDragEnded(DraggableDetails draggableDetails) {
    print("ther button is changed: " + draggableDetails.offset.dx.toString());
...
/// #######################################
enum Anchor {
  LEFT_TOP, // x < width / 4 and y < height / 4
  LEFT_CENTER, // x < width / 4 and y < height / 3
  LEFT_BOTTOM, // x < width / 4 and y < height / 2
  TOP_CENTER, // x < width / 4 and y < height / 4

  RIGHT_TOP, // x < width / 4 and y < height / 4
  RIGHT_CENTER, // x < width / 4 and y < height / 4
  RIGHT_BOTTOM, // x < width / 4 and y < height / 4
  BOTTOM_CENTER
}
